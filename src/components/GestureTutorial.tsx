...
const GestureStep: React.FC<GestureStepProps> = ({ direction, title, description, isActive }) => {
  const getIcon = () => {
    switch (direction) {
...
export const GestureTutorial: React.FC<GestureTutorialProps> = ({ onComplete, onSkip }) => {
