...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "neu-inset inline-flex h-10 items-center justify-center rounded-xl border border-border/50 bg-muted/70 p-1 text-muted-foreground",
      className,
    )}
    {...props}
  />
