              ...
              <>
                ...
                <div className="space-y-3">
                  ...
                  <Button
                    ...
                    onClick={() =>
                      toast({
                        title: 'Apple Sign-In unavailable in this build',
                        description: 'Use Google, Phone, or email/password for now. Apple Sign-In will appear automatically once platform configuration is enabled.',
                      })
                    }
                    className="w-full h-12 border-border hover:bg-secondary"
                  >
